file_name='different_filters/loudness_14.wav'; % output signal of phase 1
final_filename='different_filters/loudness_14_cheby_8thOrder.wav';
disp('ORDER 100')
...
for n=1:8
    N=8;
    Fs=16000;
    cheby=cheby_type1_order8(N,Fs,cutoff_1,cutoff_2);
   
    tic
    filtered_signal=filter(cheby,y_resampled);
    toc
